...
export const teacherServicesIntro = `
At Uniqwrites, we believe teaching is a calling, not just a career—and every educator deserves respect, dignity, and the resources to thrive. 
Our Teachers’ Hub is built to empower, protect, and elevate teaching professionals, ensuring they are equipped, valued, and indispensable in today’s evolving educational landscape.
`;
...
export const teacherServices = [
  ...
  { 
    ...
    description: "Be part of a network that protects teachers’ interests and advocates against any form of disrespect or exploitation from students, parents, or administrators.", 
    icon: "Users" 
  }
];